...
export async function syncLegacySchema() {
  try {
    ...
    const alterQueries = [
      ...
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `status` VARCHAR(50) DEFAULT 'pending'",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `current_period_end` TIMESTAMP NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `cancel_at_period_end` BOOLEAN DEFAULT false",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `payment_proof_url` TEXT NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `stripe_customer_id` VARCHAR(255) NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `stripe_subscription_id` VARCHAR(255) NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `plan_id` VARCHAR(255) NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `billing_cycle` VARCHAR(20) DEFAULT 'monthly'",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `starts_at` TIMESTAMP NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `expires_at` TIMESTAMP NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `approved_by` VARCHAR(255) NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `approved_at` TIMESTAMP NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `rejection_reason` TEXT NULL",
      "ALTER TABLE `subscriptions` ADD COLUMN IF NOT EXISTS `notes` TEXT NULL",
